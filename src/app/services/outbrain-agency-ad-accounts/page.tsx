        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-8 max-w-[540px] mx-auto lg:mx-0">
              Reach engaged audiences with Outbrain&apos;s native advertising platform. Premium placements on top publisher sites.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 mb-10 max-w-[500px] mx-auto lg:mx-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[15px] font-medium text-white">Native Content Discovery</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#E44F71]" />
                <span className="text-[15px] font-medium text-white">Top Publisher Access</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#E44F71]" />
                <span className="text-[15px] font-medium text-white">Unlimited Scaling</span>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[1.25rem] overflow-hidden border border-white/10 bg-[#150d1f] shadow-2xl p-8 lg:p-12">
              <div className="text-center">
                <div className="w-24 h-24 mx-auto mb-6 bg-white/10 rounded-2xl flex items-center justify-center shadow-2xl text-white">
                  <OutbrainIcon size={56} />
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Content Discovery</span>
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Top Publishers</span>
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Unlimited Scale</span>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <>
      <ComprehensiveSchema
        ...
        data={{
          ...schemaData,
          path: "/services/outbrain-agency-ad-accounts",
          breadcrumbs: getBreadcrumbs("/services/outbrain-agency-ad-accounts", "Outbrain Agency Accounts"),
        }}
      />
