      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-white/60 hover:text-white" aria-hidden="true">
            ...
            <a 
              ...
              className="bg-[#25D366]/10 p-2 rounded-full hover:bg-[#25D366]/20 transition-colors"
              aria-label="Contact us on WhatsApp"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-[#25D366]" aria-hidden="true">
