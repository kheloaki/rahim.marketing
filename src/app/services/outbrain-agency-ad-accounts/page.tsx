...
function OutbrainHeroSection() {
  return (
    <section className="relative pt-[140px] pb-[80px] lg:pt-[180px] lg:pb-[100px] overflow-hidden bg-[#020412]">
      <div className="absolute top-[-10%] left-[10%] w-[40%] h-[40%] rounded-full bg-[#FF6600] opacity-[0.08] blur-[120px] pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20">
          <div className="flex-1 max-w-[640px]">
            ...
            <h1 className="text-[48px] lg:text-[64px] font-bold leading-[1.1] mb-6 tracking-tight text-white">
              Outbrain Agency <br />Ad Accounts
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 mb-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[16px] font-medium text-white">Native Content Discovery</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-white" />
                <span className="text-[16px] font-medium text-white">Top Publisher Access</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-white" />
                <span className="text-[16px] font-medium text-white">Unlimited Scaling</span>
              </div>
            </div>
          ...
          <div className="flex-1 w-full lg:w-auto flex justify-center lg:justify-end relative">
            <div className="relative w-full max-w-[500px] aspect-square bg-[#080B1E] border border-white/10 rounded-[24px] overflow-hidden flex items-center justify-center">
              <div className="text-center p-8">
                <div className="w-24 h-24 mx-auto mb-6 bg-[#FF6600] rounded-2xl flex items-center justify-center shadow-2xl">
                  <span className="text-white text-2xl font-bold">Outbrain</span>
                </div>
                <h3 className="text-[32px] font-bold text-white mb-4">Outbrain Ads</h3>
