...
const testimonials = [
  ...
  },
  {
    ...
    content: "“Got banned 3 times in half a year. Since moving to Uproas, zero issues. Before, every campaign felt like gambling. Now accounts have been solid for 4 months straight and we’ve scaled past $150K/month without a single ban.”",
  ...
  },
  {
    ...
    content: "“I’ve tried at least five providers before. None of them lasted more than a few weeks. With Uproas, it’s the first time I’ve had both stable accounts and actual support. Even Meta reps answer now. Total game-changer.”",
            ...
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              <div className="flex items-center gap-4 mb-6">
                 ...
                 <div>
                    ...
                    <div className="text-white/40 text-sm">SaaS Founder & Uproas Client</div>
                 </div>
              </div>
