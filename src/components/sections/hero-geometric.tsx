...
export default function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0a0612]">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#0a0612] via-transparent to-[#0a0612]/80 pointer-events-none" />
    </div>
  )
}
