...
const HowItWorks = () => {
  return (
    <section className="relative py-[120px] md:py-[160px] bg-[#02040a] overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#d946a8] opacity-[0.05] blur-[150px] rounded-full pointer-events-none" />
      
      <div className="container mx-auto px-5 lg:px-10 relative z-10">
        {/* Header */}
        <div className="text-center mb-16 md:mb-24">
          <div className="inline-block px-4 py-1.5 mb-6 rounded-full border border-[rgba(43,89,255,0.3)] bg-[rgba(43,89,255,0.1)] text-[#d946a8] text-sm font-semibold tracking-wide uppercase">
            Process
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-6 space-y-12">
            ...
            <div className="group relative flex gap-6">
              <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[rgba(43,89,255,0.1)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center text-[#d946a8] font-bold text-xl group-hover:bg-[#d946a8] group-hover:text-white transition-all duration-300">
                1
              </div>
              <div>
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative group p-1 rounded-[2rem] bg-gradient-to-br from-[rgba(43,89,255,0.2)] via-transparent to-[rgba(0,204,255,0.2)] shadow-2xl overflow-hidden aspect-square flex items-center justify-center">
              ...
              <div className="absolute inset-2 rounded-[1.8rem] bg-[#150d1f] border border-[rgba(255,255,255,0.05)]" />
              ...
              <div className="relative z-10 w-full h-full p-8 md:p-12 flex flex-col items-center justify-center text-center">
                <div className="relative w-full max-w-[400px]">
                  ...
                  <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#d946a8] opacity-20 blur-[60px] rounded-full animate-pulse" />
                  ...
                  <div className="relative glass-panel rounded-2xl p-8 border border-[rgba(255,255,255,0.1)] bg-[rgba(10,13,26,0.6)] shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform -rotate-2 hover:rotate-0 transition-transform duration-500">
                    <div className="flex justify-between items-start mb-12">
                      <div className="w-12 h-8 bg-gradient-to-r from-[#d946a8] to-[#f97316] rounded-md opacity-80" />
