          ...
          <div className="flex-1 max-w-[640px]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 mb-10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[16px] font-medium text-white">Aged Profiles</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-white" />
                <span className="text-[16px] font-medium text-white">Verified Accounts</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-white" />
                <span className="text-[16px] font-medium text-white">Ready for Ads</span>
              </div>
            </div>
          ...
          <div className="flex-1 w-full lg:w-auto flex justify-center lg:justify-end relative">
            <div className="relative w-full max-w-[500px] aspect-square bg-[#080B1E] border border-white/10 rounded-[24px] overflow-hidden flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <h3 className="text-[32px] font-bold text-white mb-4">Facebook Accounts</h3>
                <p className="text-white/60">Premium Verified Profiles</p>
              </div>
            </div>
          </div>
        </div>
