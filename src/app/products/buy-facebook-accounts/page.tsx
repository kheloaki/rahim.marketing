        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-8 max-w-[540px] mx-auto lg:mx-0">
              Aged, verified Facebook profiles ready for advertising. Premium quality accounts with proper history and verification.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 mb-10 max-w-[500px] mx-auto lg:mx-0">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[15px] font-medium text-white">Aged Profiles</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#E44F71]" />
                <span className="text-[15px] font-medium text-white">Verified Accounts</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#E44F71]" />
                <span className="text-[15px] font-medium text-white">Ready for Ads</span>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[1.25rem] overflow-hidden border border-white/10 bg-[#150d1f] shadow-2xl p-8 lg:p-12">
              <div className="text-center">
                ...
                <h3 className="text-[28px] font-bold text-white mb-4">Facebook Accounts</h3>
                <p className="text-white/60 mb-8">Premium Verified Profiles</p>
                <div className="flex flex-wrap justify-center gap-2">
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Aged Profiles</span>
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Verified</span>
                  <span className="bg-[#E44F71]/20 text-[#E44F71] px-3 py-1 rounded-full text-xs font-semibold">Ad Ready</span>
                </div>
              </div>
            </div>
          </div>
...
export const metadata = metaFromSchema(productPageSchemas["buy-facebook-accounts"], "/products/buy-facebook-accounts");
