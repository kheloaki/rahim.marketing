      ...
      <div className="relative w-full max-w-[800px] bg-[#150d1f] border border-white/10 rounded-[20px] glow-blue overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex justify-end p-6 pb-0">
          <button 
            ...
            className="flex items-center gap-2 text-[14px] text-white/60 hover:text-white transition-colors py-2 px-4 rounded-lg border border-white/10"
          >
            I&apos;m not Interested
          </button>
        </div>

        <div className="px-6 md:px-12 pb-12 pt-4 flex flex-col items-center">
          {/* Main Title */}
          <h2 className="text-[32px] md:text-[40px] font-bold text-center leading-[1.1] mb-4 text-white">
            Unlock the Complete High-Risk <br /> Facebook Ads Playbook
          </h2>
          
          <p className="text-[16px] md:text-[18px] text-white/60 text-center max-w-[600px] mb-10">
          ...
          {/* Book Mockup Section */}
          <div className="w-full glass-panel rounded-[16px] p-6 mb-8 flex flex-col md:flex-row items-center gap-8 border-white/5">
            <div className="relative w-[280px] h-[180px] shrink-0">
              ...
              <div className="relative flex items-center justify-center">
                <Image 
                  ...
                  width={120}
                  height={160}
                  className="relative z-30 shadow-2xl rounded-sm transform -rotate-6 -translate-x-8"
                />
                <Image 
                ...
                <Image 
                  ...
                  width={120}
                  height={160}
                  className="absolute z-30 shadow-2xl rounded-sm transform rotate-6 translate-x-8"
                />
              </div>
            </div>

            <div className="flex-1">
              <p className="text-[14px] font-semibold text-white/40 uppercase tracking-wider mb-4">You Unlock All 3 Books Including:</p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded bg-primary text-[12px] font-bold shrink-0 mt-0.5">1</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded bg-primary text-[12px] font-bold shrink-0 mt-0.5">2</span>
                  <p className="text-[15px] font-medium text-white/90">
                ...
                <li className="flex items-start gap-3">
                  <span className="flex items-center justify-center w-6 h-6 rounded bg-primary text-[12px] font-bold shrink-0 mt-0.5">3</span>
                  <p className="text-[15px] font-medium text-white/90">
          ...
          {/* Lead Gen Form */}
          <div className="w-full bg-[#E44F71] rounded-[16px] p-6 md:p-8">
            <h3 className="text-[20px] font-bold text-white mb-6">Enter Your Details to Get the Books Free</h3>
            
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-[14px] text-white/80 font-medium">Your Name</label>
                  <input 
                    type="text" 
                ...
                <div className="space-y-2">
                  <label className="text-[14px] text-white/80 font-medium">Business Email Address</label>
                  <input 
                    type="email" 
              ...
              <div className="flex bg-[#150d1f]/40 p-1.5 rounded-[8px] border border-white/10 w-fit">
                ...
                >
                  <div className={`w-3 h-3 rounded-full border border-white/20 flex items-center justify-center ${platform === 'telegram' ? 'bg-[#E44F71]' : ''}`}>
                ...
                >
                  <div className={`w-3 h-3 rounded-full border border-white/20 flex items-center justify-center ${platform === 'whatsapp' ? 'bg-[#E44F71]' : ''}`}>
              ...
              <button className="w-full h-[56px] bg-[#1a42cc] hover:bg-[#1534a6] text-white font-bold rounded-[8px] flex items-center justify-center gap-2 transition-all shadow-lg active:scale-[0.98]">
          ...
          <div className="w-full border-t border-white/10 mt-10 pt-8">
            ...
            <p className="text-[15px] italic text-white/80 leading-relaxed mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[12px] text-white/50">SaaS Founder & Rahim Marketing Client</p>
              </div>
            </div>
          </div>

          {/* Accordion Footer */}
          <div className="w-full mt-6 border border-white/10 rounded-[12px] overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 cursor-pointer hover:bg-white/5 transition-colors">
              <span className="text-[14px] font-bold text-white uppercase tracking-wider">What You&apos;ll Get:</span>
