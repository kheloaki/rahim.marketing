      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a href="https://t.me/rahim_ou" className="bg-white/5 p-2 rounded-full hover:bg-white/10 transition-colors">
            ...
            <a href="https://wa.me/message/WKWQWAZSRAU3N1" className="bg-[#25D366]/10 p-2 rounded-full hover:bg-[#25D366]/20 transition-colors">
