              ...
              <div className="lg:col-span-8 flex flex-col gap-6">
                ...
                <div className="mt-4 pt-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                  <div className="max-w-[440px]">
                    <h3 className="text-[18px] font-semibold mb-3">Uproas Satisfaction Guarantee</h3>
                    <p className="text-[14px] text-white/60 leading-relaxed mb-4">
                      Uproas guarantees access to premium ad accounts with direct access to a professional support team.
                    </p>
