...
import { Clock, Bell, ArrowLeft, Send, MessageCircle } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a0612]">
      ...
      <div className="pt-[89px]">
        <section className="min-h-[80vh] flex items-center justify-center relative overflow-hidden">
          ...
          <div className="container relative z-10 px-5 lg:px-10 max-w-[700px] mx-auto text-center">
            <div className="mb-8 inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#E44F71]/10 border border-[#E44F71]/20">
              <Clock className="w-10 h-10 text-[#E44F71]" />
            </div>

            <div className="inline-flex items-center px-4 py-2 rounded-full border border-[#E44F71]/30 bg-[#E44F71]/10 text-[#E44F71] text-sm font-semibold tracking-wide uppercase mb-6">
              Coming Soon
            </div>
