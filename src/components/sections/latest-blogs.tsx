    ...
    <section className="bg-[#02040a] py-[120px] lg:py-[160px]">
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-[64px] gap-6">
          ...
          <a
            href="/blog"
            className="flex items-center gap-2 text-white font-semibold hover:text-[#d946a8] transition-colors"
          >
            view all
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogPosts.map((post) => (
            <a
              key={post.id}
              href={post.link}
              className="group flex flex-col bg-[#150d1f] border border-[rgba(255,255,255,0.1)] rounded-[16px] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-[#d946a8]/30"
            >
              {/* Thumbnail Container */}
              <div className="relative aspect-[16/9] w-full bg-[#121629] overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#d946a8]/20 to-transparent z-10 opacity-60" />
                <div className="absolute inset-0 flex items-center justify-center p-12">
                   ...
                   <div className="relative w-full h-full flex items-center justify-center">
                      <div className="absolute w-[80%] h-[80%] bg-[#d946a8]/10 blur-[40px] rounded-full" />
                      <Image 
                        src={post.image}
                        alt={post.title}
                        width={80}
                ...
                {/* Arrow Icon Badge */}
                <div className="absolute bottom-4 right-4 z-20 bg-[#d946a8] p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="text-[#d946a8] text-[14px] font-semibold uppercase tracking-wider mb-3">
                  {post.category}
                </div>
                <h3 className="text-[24px] font-semibold leading-[1.3] text-white mb-4 group-hover:text-[#d946a8] transition-colors line-clamp-2">
                  {post.title}
                </h3>
